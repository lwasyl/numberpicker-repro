 ...
 * <p>
 * Modified to work around https://github.com/gradle/gradle/issues/1010
 */
public class LoggerWrapper implements ILogger {

    public static class Switch {
        public static boolean shouldShowInfoLogsAsLifecycle = false;
    }
    ...
    private void log(@NonNull LogLevel logLevel, @NonNull String s, @Nullable Object[] objects) {
        if (Switch.shouldShowInfoLogsAsLifecycle && logLevel == LogLevel.INFO) {
